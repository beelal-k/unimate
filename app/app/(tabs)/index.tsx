...
import {
  ...
  Clock, ArrowRight, Sparkles, AlertTriangle, Bell, ChevronRight, FileText, Settings, User
...
function formatShortDate(dateStr: string): string {
  ...
  const dueNormalized = new Date(date.getFullYear(), date.getMonth(), date.getDate());
