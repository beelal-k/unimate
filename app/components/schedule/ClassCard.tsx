          ...
          {showAvatar && participants.length > 0 && (
            <View style={{ flexDirection: 'row' }}>
              ...
              {participants.length > 3 && (
                <View style={{ marginLeft: -8, width: 24, height: 24, borderRadius: 12, backgroundColor: '#E0E0E0', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#FFF' }}>
                  <Text style={{ fontSize: 9, fontFamily: 'Inter_600SemiBold', color: '#6E6E6E' }}>+{participants.length - 3}</Text>
                </View>
              )}
            </View>
          )}
